...
import { ref, toRef, reactive, computed, watch, onMounted } from "vue";
import cusDialogProps from "./props";
...
let props = defineProps(cusDialogProps);
let showDialog = ref<boolean>(props.showDialog);
// let showDialog = toRef(props, "showDialog");
