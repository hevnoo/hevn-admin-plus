    ...
    >
      ...
      <template v-else-if="item?.itemRender?.name === 'datetime'">
        <el-date-picker
          ...
          :placeholder="item?.itemRender?.props?.placeholder || '请选择日期时间'"
          :format="item?.itemRender?.props?.timeFormat"
        />
      </template>
      <template v-else-if="item?.itemRender?.name === 'time'">
        <el-time-picker
          ...
          :placeholder="item?.itemRender?.props?.placeholder || '请选择时间范围'"
        />
      </template>
...
import cusFormProps from "./props";
...
const emits = defineEmits(["submitForm", "resetForm", "confirm", "changeInput", "changeSelect"]);
let props = defineProps(cusFormProps);
    ...
    newItem = {
      ...
      itemRender: {
        ...
        props: {
          ...
          clearable: item?.clearable || item?.itemRender?.props?.clearable || false,
          disabled: item?.disabled || item?.itemRender?.props?.disabled || false,
          placeholder: item?.placeholder || item?.itemRender?.props?.placeholder,
          ...
          //级联选择器props
          cascaderProps: item?.cascaderProps || item?.itemRender?.props?.cascaderProps,
          //时间选择器format
