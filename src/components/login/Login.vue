    ...
    <div class="container" :class="{ 'right-panel-active': isRightPanelActive }" id="container">
      <div class="form-container sign-up-container">
        <form @submit.prevent="handleSignUp">
          ...
          <div class="social-container">
            <a href="#" class="social" v-for="(icon, index) in socialIcons" :key="index" v-html="icon"></a>
          </div>
          <span>输入邮箱</span>
      ...
      <div class="form-container sign-in-container">
        <form @submit.prevent="handleSignIn">
          ...
          <input v-model="signInForm.email" type="email" placeholder="Email" />
      ...
      <div class="overlay-container">
        <div class="overlay">
          <div class="overlay-panel overlay-left">
            <h1>欢迎回来!</h1>
            <p>请登录</p>
            <button class="ghost" @click="toSignIn">登录</button>
          </div>
